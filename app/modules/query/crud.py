...
class QueryCRUD:
    ...
    async def execute_query(
        ...
        try:
            ...
            for doc in cursor:
                ...
                # Extract core fields - symbol is required
                symbol = doc.get("symbol")
                if not symbol:
                    continue  # Skip documents without symbol
    ...
    async def get_available_fields(self) -> list[str]:
        ...
        try:
            ...
            if sample_doc:
                ...
                fields = [field for field in sample_doc if field not in excluded_fields]
    ...
    async def get_field_stats(self, field_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            result = list(self.collection.aggregate(pipeline))  # type: ignore[arg-type]
            if result:
                stats = result[0]
                stats.pop("_id", None)
                return stats
