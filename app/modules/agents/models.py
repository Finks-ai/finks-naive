...
from app.modules.agents.field_extraction.models import (
...
from app.modules.agents.synthesis.models import (
    SynthesisRequest,
    SynthesisResponse,
    FieldPriority
)
from app.modules.agents.query_generation.models import (
    QueryGenerationRequest,
    QueryGenerationResponse
)
from app.modules.agents.sorting_extraction.models import (
    SortingIntent,
...
class AgentPipelineRequest(BaseModel):
    ...
    previous_context: Optional[PreviousQueryContext] = Field(
        None, 
        description="Previous query context for refinements (used for follow-up queries)"
    )
    ...
    model_config = {
        "json_schema_extra": {
            "examples": [
                {
                    "query": "Find cheap profitable stocks",
                    "max_results": 5
                },
                {
                    "query": "Show me technology companies with high growth",
                    "max_results": 10
                }
            ]
        }
